...
namespace SocialMediaPlatform.Server.Migrations
{
    ...
    [Migration("20250225190821_story")]
    partial class story
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "abac3b5a-47dd-4a4f-b0e7-e77b0b521fbe",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "ea644826-1ea5-4151-9ce5-c026a79dc3d6",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("SocialMediaPlatform.Server.Models.Conversation", b =>
                {
                    ...
                    b.Property<List<string>>("PendingUserIds")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<List<string>>("SeenUserIds")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("SocialMediaPlatform.Server.Models.Story", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SocialMediaPlatform.Server.Models.Follow", b =>
                {
                    b.HasOne("SocialMediaPlatform.Server.Models.ApplicationUser", "Follower")
                        .WithMany("Following")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SocialMediaPlatform.Server.Models.ApplicationUser", "Following")
                        .WithMany("Followers")
